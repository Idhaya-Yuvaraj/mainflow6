...
def total_bills():
    ...
    if bill_details.get(1.0,"end") != "":
        ...
        bill_details.insert(1.0,f"\nDal Makhni:({dal_makhni_q}) \t\t{total_dal_makhni_price}\n")
        bill_details.insert(1.0,f"\nParatha:({paratha_q}) \t\t{total_paratha_price}\n")
        bill_details.insert(1.0,f"\nOmelete:({omelete_q}) \t\t{total_omelete_price}\n")

        bill_details.insert(1.0,f"\nLassi:({lassi_q}) \t\t{total_lassi_price}\n")
        bill_details.insert(1.0,f"\nTea:({tea_q}) \t\t{total_tea_price}\n")
        bill_details.insert(1.0,f"\nShakes:({shakes_q}) \t\t{total_shakes_price}\n")
...
def send():
    ...
    def send_bill():
        ...
        if ph_number == "":
            ...
            api = "uMToVSrJHcaRAq5iI4ejvD9WwtUKCNFfBpPE3yX1QZm8k7l2OsrfU243TjsKpd1WhntmBFVXwRPMG8DL"
